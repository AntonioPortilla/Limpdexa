...
<head>
	...
	<link rel="shortcut icon" href="<?php echo home_url(); ?>/wp-content/themes/limpdex/images/favicon.png">
    <!-- WP_Head -->
        <?php wp_head(); ?>
    <!-- /WP_Head -->
</head>
	...
	<div id="wrap">
            ...
            <header id="header">
                <div class="header-top">
                    <div class="container">
                        <div class="row">
                            <div class="header-top-left col-xs-12 col-sm-12 col-md-3">
                                <a href="<?php echo home_url(); ?>/" class="ql_logo google-font">
                                    <?php //bloginfo('name'); ?>
                                    <img src="<?php echo home_url(); ?>/wp-content/themes/limpdex/images/limpdexa.png" alt="limpdexa mept">
                                </a>
                            </div>
                            <div class="header-top-right col-xs-12 col-sm-12 col-md-9">
                                <?php dynamic_sidebar( 'searchTop' ); ?>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container header-bottom">
                    <div class="row">
                        ...
                        <div class="ql_logo_nav col-md-12 col-xs-12">
